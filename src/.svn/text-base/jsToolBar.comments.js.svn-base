...
function removeListener(element, name, handler) {
...
function jsToolBar(textarea) {
	...
	var This = this;
	addListener(this.handle,'mousedown',function(event) {
...
jsToolBar.prototype.resizeDragStart = function(event) {
	...
	addListener(document,'mousemove', this.dragMoveHdlr=function(event){This.resizeDragMove(event);});
	addListener(document,'mouseup', this.dragStopHdlr=function(event){This.resizeDragStop(event);});
};
